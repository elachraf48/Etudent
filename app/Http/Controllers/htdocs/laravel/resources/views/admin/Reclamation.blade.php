...
<hr>
    ...
    <script>
        $(document).ready(function() {
            ...
            change_reclamations();
            $('#AnneeUniversitaire, #semesterDropdown, #filiereDropdown, #moduleDropdown, #professeurDropdown,#sessions,#stratu').change(function() {
                change_reclamations();
            });
            ...
            $('#semesterDropdown').change(function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        var optionsHtml = '<option value="%25">All</option>';

                        if (selectedSemester != '%25') {
        ...
        function change_reclamations() {
            ...
            var url = '/fetch-reclamations/' + AnneeUniversitaire + '/' + module + '/' + semester + '/' + filiere + '/' + professeur + '/' + sessions + '/' + stratu + '?_=' + cacheBuster;
        ...
        function change_professeurs(selectedmodule) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    optionsHtml = '<option value="%25">All</option>' + optionsHtml;
