...
<div class="error">
  ...
  <button class="error__button error__button--active">        
    <a style="text-decoration: none;font-size: large; color: white;" href="{{ route('dashboard') }}">Go to Homepage</a>
  </button>
