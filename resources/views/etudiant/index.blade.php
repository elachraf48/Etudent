                    ...
                    <div class="row justify-content-center">
                        <div class="col-12">
                            <div class="form-group">
                                <input type="text" name="code_apogee" class="form-control shadow" placeholder="Enter Code Apogee" >
                            </div>
                        </div>
                        <div class="col-12"> <!-- Make the column full-width -->
                            <button type="button" class="btn btn-primary w-100 mt-2 shadow" onclick="searchStudent()">Trouver</button>
                        </div>
                        <div class="col-md-12">
